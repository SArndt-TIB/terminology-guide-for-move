...
<!-- ![Screenshort des TIB Terminology Service, der die Suche nach dem Suchstring "battery-electric ve" zeigt](images/tib-ts-search.png) -->

Die verschiedenen indexierten Vokabulare sind relativ heterogen, da sie nach unterschiedlichen Standards und für verschiedene Zwecke erstellt werden. Alles in allem, können die einzelnen Vokabulare jedoch eine Reihe von Use Cases unterstützen:

* Recherche nach fachlichen Konzepten aus Ontologien, kontrollierten Vokabularen, und Klassifikationen
* Recherche nach Definitionen
* Recherche nach Synonymen
* Recherche nach fremdsprachigen Äquivalenten
* Recherche nach Begriffsbeziehungen
