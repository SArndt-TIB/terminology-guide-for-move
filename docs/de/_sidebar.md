...
* Terminologie
  ...
  * [Elemente einer Terminologie](terminology-5.md)
  * [Aufgaben der Terminologiearbeit](terminology-6.md)
  * [Formen der Terminologiedokumentation](terminology-4.md)
...
* [Tutorial](tutorial-intro.md)
  ...
  * [Daten sammeln, als CSV dokumentieren und nach RDF konvertieren](tutorial-12.md)
    * [Tabellarische Datenverwaltung für CSV-RDF-Mapper](tutorial-13.md)
  ...
  * [Validierung, Qualitätsprüfung, FAIRness](tutorial-9.md)
* Tools
  * [... zur Recherche](tools_Recherche-intro.md)
    <!-- * [DIN-TERM/ DIN-TERMinologieportal](tools_Recherche-DIN-Term.md) -->
    <!-- * [ISO Open Browsing Platform](tools_Recherche-ISO_OBP.md) -->
    <!-- * [VDE-Wörterbuch/ Electropedia](tools_Recherche-VDE_electropedia.md) -->
    <!-- * [VDI-Term](tools_Recherche-VDI_Term.md) -->
    <!-- * [TIB Terminology Service](tools_Recherche-TIB_TS.md) -->
    <!-- * [Bartoc](tools_Recherche-Bartoc.md) -->
    <!-- * [Linked Open Vocabularies](tools_Recherche-LOV.md) -->
  * [... für SKOS](tools_SKOS-intro.md)
    <!-- * [](tools_SKOS-CSV2RDF.md) -->
    <!-- * [](tools_SKOS-SKOSPlay.md) -->
  * [... für SHACL](tools_SHACL_intro.md)
